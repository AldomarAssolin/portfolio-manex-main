        ...
        <div class="col-lg-4 sticky-lg-top vh-100">
            <div class="d-flex flex-column h-100 text-center overflow-auto shadow px-2">
                ...
                <nav class="nav navbar text-center">
                    <ul class="nav nav-pills nav-sidebar flex-md-column justify-content-center w-100" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('public.blog.index') }}" class="nav-link {{ request()->is('blog') ? 'active' : '' }}">
